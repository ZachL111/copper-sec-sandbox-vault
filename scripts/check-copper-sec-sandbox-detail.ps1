...
$repo = "copper-sec-sandbox-vault"
$language = "PHP"
$category = "Security tooling"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/copper-sec-sandbox-walkthrough.md")) {
