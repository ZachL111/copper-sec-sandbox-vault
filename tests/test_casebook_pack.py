"""Regression checks for the copper-sec-sandbox-vault casebook."""
...
from casebook.harness import assert_expected, copper_sec_sandbox_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_sec_sandbox_vault_summary(), assert_expected())
